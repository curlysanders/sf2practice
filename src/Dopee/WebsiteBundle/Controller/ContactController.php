...
use Dopee\WebsiteBundle\Entity\Contact;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DopeeWebsiteBundle:Contact')->findAll();
     ...
     * @Method("POST")
     * @Template("DopeeWebsiteBundle:Contact:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DopeeWebsiteBundle:Contact')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DopeeWebsiteBundle:Contact:edit.html.twig")
     */
